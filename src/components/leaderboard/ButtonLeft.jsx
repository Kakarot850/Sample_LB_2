        ...
        <div className="relative hover:scale-105 transition-transform duration-200 cursor-pointer">
            <div className="">
                <svg width="185" height="35" viewBox="0 0 185 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_158_615)">
                        <mask id="path-1-inside-1_158_615" fill="white">
                        ...
                        <path
                            ...
                            fill-opacity="0.07"
                        />
                        <g opacity="0.24" filter="url(#filter0_f_158_615)">
                            <ellipse cx="93" cy="38.5" rx="57" ry="35" fill="#0037FF" />
                        </g>
                    </g>
                    <path
                        ...
                        fill="url(#paint0_linear_158_615)"
                        fill-opacity="0.56"
                        mask="url(#path-1-inside-1_158_615)"
                    />
                    <defs>
                        <filter
                            id="filter0_f_158_615"
                            x="-16.3"
                            y="-48.8"
                            width="218.6"
                            height="174.6"
                        ...
                        >
                            ...
                            <feGaussianBlur stdDeviation="26.15" result="effect1_foregroundBlur_158_615" />
                        </filter>
                        <linearGradient
                            id="paint0_linear_158_615"
                            x1="0"
                            y1="17.5"
                            x2="185"
                            y2="17.5"
                        ...
                        >
                            <stop stop-color="#0015FF" stop-opacity="0.25" />
                            <stop offset="0.5" stop-color="#002FFF" />
                            <stop offset="1" stop-color="#0015FF" stop-opacity="0.25" />
                        </linearGradient>
            ...
            <div className="absolute inset-0 uppercase flex items-center justify-center gap-2 text-white text-[11px] font-extrabold tracking-0 font-archivo">
                <div className="flex items-center gap-1 rounded-full  px-5 py-2 text-[11px] uppercase tracking-[0.2em] text-gray-200">
                    <span>Code:</span>
                    <span className="font-semibold text-white uppercase">rydurz</span>
