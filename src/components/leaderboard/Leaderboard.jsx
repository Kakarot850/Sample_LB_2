                ...
                <div className="absolute  top-10 left-[50%] -translate-x-1/2 flex flex-col items-center px-4 gap-15 ">
                    <div className="flex flex-col items-center gap-0">
                        ...
                        <div className="relative">
                            <div class="absolute w-[698px] h-[73px] bg-[#4F26E3] opacity-35 blur-[75.12px] top-1/2 -translate-y-1/2"></div>

                            <img src="/leaderboard/title-logo.png" alt="Leaderboard" className="" />
                        </div>
                    ...
                    <div className="flex flex-col items-center gap-2 -mt-10 ">
                        <p className="text-[17px] uppercase tracking-[0.15em] text-gray-300 font-bold font-archivo">
                            Leaderboard ends in
                        </p>
                        <Timer />
                    </div>
